...
import 'package:kedakopi/models/cart_model.dart';
...
class CartProvider with ChangeNotifier {
  ...
  void addRemove(String name, int? price, int menuId, bool isAdd) {
    if (_cart.where((element) => menuId == element.menuId).isNotEmpty) {
      ...
      // belum ada
      _cart.add(
          CartModel(name: name, price: price, menuId: menuId, quantity: 1));
      _total = _total + 1;
    }
    notifyListeners();
  }
